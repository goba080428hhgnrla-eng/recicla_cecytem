# Generated by Django 4.1.13 on 2025-12-09 03:02
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='usuario',
            index=models.Index(fields=['rol'], name='MarketPlace_rol_350336_idx'),
        ),
        migrations.AddIndex(
            model_name='usuario',
            index=models.Index(fields=['fecha_registro'], name='MarketPlace_fecha_r_336db9_idx'),
        ),
        migrations.AddField(
            model_name='producto',
            name='id_categoria',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MarketPlace.categoria'),
        ),
        migrations.AddField(
            model_name='producto',
            name='id_usuario',
        ...
        migrations.AddField(
            model_name='pago',
            name='id_orden',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MarketPlace.ordenventa'),
        ),
        migrations.AddField(
            model_name='ordenventa',
            name='id_usuario_comprador',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='compras_realizadas', to='MarketPlace.usuario'),
        ),
        migrations.AddField(
            model_name='ordenventa',
            name='id_usuario_vendedor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ventas_realizadas', to='MarketPlace.usuario'),
        ),
        migrations.AddField(
            model_name='mensaje',
            name='id_conversacion',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MarketPlace.conversacion'),
        ),
        migrations.AddField(
            model_name='mensaje',
            name='id_usuario',
        ...
        migrations.AddField(
            ...
            name='id_carrito',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MarketPlace.carrito'),
        ),
        migrations.AddField(
            model_name='itemcarrito',
            name='id_producto',
        ...
        migrations.AddConstraint(
            model_name='producto',
            constraint=models.CheckConstraint(check=models.Q(('precio_kg__gte', 0)), name='precio_positivo'),
        ),
        migrations.AddConstraint(
            model_name='producto',
            constraint=models.CheckConstraint(check=models.Q(('peso_disponible_kg__gte', 0)), name='peso_positivo'),
        ),
        migrations.AddIndex(
            model_name='pago',
            index=models.Index(fields=['id_orden'], name='MarketPlace_id_orde_d635b1_idx'),
        ),
        migrations.AddIndex(
            model_name='pago',
            index=models.Index(fields=['estado_pago'], name='MarketPlace_estado__7ebb09_idx'),
        ),
        migrations.AddIndex(
            model_name='pago',
            index=models.Index(fields=['metodo_pago'], name='MarketPlace_metodo__7700df_idx'),
        ),
        migrations.AddIndex(
            model_name='pago',
            index=models.Index(fields=['fecha'], name='MarketPlace_fecha_468b65_idx'),
        ),
        migrations.AddConstraint(
            model_name='pago',
            constraint=models.CheckConstraint(check=models.Q(('monto__gt', 0)), name='monto_positivo'),
        ),
        migrations.AddIndex(
            model_name='ordenventa',
        ...
        migrations.AddConstraint(
            model_name='ordenventa',
            constraint=models.CheckConstraint(check=models.Q(('total__gte', 0)), name='total_positivo'),
        ),
        migrations.AddIndex(
            model_name='mensaje',
        ...
        migrations.AddIndex(
            model_name='itemcarrito',
            index=models.Index(fields=['id_carrito'], name='MarketPlace_id_carr_9a7325_idx'),
        ),
        migrations.AddIndex(
            model_name='itemcarrito',
            index=models.Index(fields=['id_producto'], name='MarketPlace_id_prod_134257_idx'),
        ),
        migrations.AddConstraint(
            model_name='itemcarrito',
            constraint=models.CheckConstraint(check=models.Q(('cantidad_kg__gt', 0)), name='cantidad_positiva'),
        ),
        migrations.AddConstraint(
            model_name='itemcarrito',
            constraint=models.CheckConstraint(check=models.Q(('precio_unitario__gte', 0)), name='precio_unitario_positivo'),
        ),
        ...
        migrations.AddIndex(
            model_name='detalleorden',
            index=models.Index(fields=['id_orden'], name='MarketPlace_id_orde_e08a54_idx'),
        ),
        migrations.AddIndex(
            model_name='detalleorden',
            index=models.Index(fields=['id_producto'], name='MarketPlace_id_prod_71a9ba_idx'),
        ),
        migrations.AddConstraint(
            model_name='detalleorden',
            constraint=models.CheckConstraint(check=models.Q(('cantidad_kg__gt', 0)), name='detalle_cantidad_positiva'),
        ),
        migrations.AddConstraint(
            model_name='detalleorden',
            constraint=models.CheckConstraint(check=models.Q(('precio_unitario__gte', 0)), name='detalle_precio_positivo'),
        ),
        migrations.AddIndex(
            model_name='conversacion',
