# Generated by Django 5.2.8 on 2026-01-19 17:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metodo_pago', models.CharField(choices=[('tarjeta', 'Tarjeta'), ('transferencia', 'Transferencia'), ('efectivo', 'Efectivo'), ('paypal', 'PayPal'), ('stripe', 'Stripe'), ('otro', 'Otro')], max_length=15)),
                ('monto', models.DecimalField(decimal_places=2, max_digits=10)),
                ('fecha', models.DateTimeField(auto_now_add=True)),
                ('estado_pago', models.CharField(choices=[('pendiente', 'Pendiente'), ('completado', 'Completado'), ('fallido', 'Fallido'), ('cancelado', 'Cancelado'), ('reembolsado', 'Reembolsado')], default='pendiente', max_length=15)),
                ('transaccion_id', models.CharField(blank=True, max_length=100, null=True)),
                ('referencia_pago', models.CharField(blank=True, max_length=200, null=True)),
            ...
            options={
                ...
                'ordering': ['-fecha'],
                'indexes': [models.Index(fields=['id_orden'], name='MarketPlace_id_orde_d635b1_idx'), models.Index(fields=['estado_pago'], name='MarketPlace_estado__7ebb09_idx'), models.Index(fields=['metodo_pago'], name='MarketPlace_metodo__7700df_idx'), models.Index(fields=['fecha'], name='MarketPlace_fecha_468b65_idx'), models.Index(fields=['transaccion_id'], name='MarketPlace_transac_4600ee_idx'), models.Index(fields=['paypal_payment_id'], name='MarketPlace_paypal__32cbd4_idx')],
