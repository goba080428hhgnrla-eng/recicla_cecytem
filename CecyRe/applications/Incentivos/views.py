...
# funciones de ayuda (HELPER FUNctitones)
...
# paginas de inicoo de las views
...
def recompensas(request):
    ...
    context = {
        ...
        'recolector': recolector  # en caso de que lo necesite el  template
    }
